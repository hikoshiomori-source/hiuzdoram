            ...
            {dbDramas.map((drama: any, i: number) => {
              ...
              return (
                <Link
                  key={drama.id}
                  href={`/watch/${drama.id}`}
                  className="flex items-center gap-4 md:gap-6 p-4 rounded-2xl bg-surface-container-lowest hover:bg-surface-container-low border border-transparent hover:border-border-glass transition-premium group animate-card-entrance"
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <h2 className="text-base md:text-lg font-bold text-on-surface truncate group-hover:text-primary transition-premium">
                      {drama.title}
                    </h2>
